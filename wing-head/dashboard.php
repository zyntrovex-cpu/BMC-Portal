  ...
  <div class="col-lg-5">
    <div class="sec-card">
      ...
      <div style="padding:12px 16px">
        ...
        <?php endforeach; ?>
        <a href="/wing-head/classes.php" class="btn btn-sm btn-outline-secondary w-100 mt-1" style="font-size:.8rem">Manage Classes</a>
      </div>
    </div>
  </div>
  <div class="col-lg-7">
    <div class="sec-card">
      ...
      <div style="padding:12px 16px">
        ...
        <?php endforeach; ?>
        <?php endif; ?>
        <a href="/wing-head/students.php" class="btn btn-sm btn-outline-secondary w-100 mt-2" style="font-size:.8rem">View All Students</a>
      </div>
    </div>
  </div>
</div>
