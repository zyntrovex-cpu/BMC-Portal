  ...
  <div class="col-lg-3">
    <div class="sec-card">
      ...
      <div style="padding:12px 16px">
        <a href="/ilc/disabilities.php<?= $search?'?q='.urlencode($search):'' ?>"
    ...
    <div class="sec-card">
      <div class="sec-card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <form method="GET" class="d-flex gap-2">
          ...
          <?php if ($search||$catFilter): ?><a href="/ilc/disabilities.php" class="btn btn-sm btn-outline-danger">Clear</a><?php endif; ?>
        </form>
      </div>

      <?php if (empty($records)): ?>
      <div style="padding:40px;text-align:center;color:var(--t2);font-size:.85rem">
        No disability records found. Go to a <a href="/ilc/students.php">student profile</a> to add records.
      </div>
      <?php else: ?>
        ...
        <table class="table table-hover mb-0" style="font-size:.84rem">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="/ilc/student-profile.php?id=<?= $r['student_id'] ?>" class="btn btn-xs btn-outline-primary" style="font-size:.74rem;padding:2px 7px">
