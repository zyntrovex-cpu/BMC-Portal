...
<div class="sec-card mb-3">
  <div class="sec-card-header"><i class="fas fa-filter me-2"></i>Select Class</div>
  <div style="padding:12px 16px">
    <form method="GET" class="d-flex gap-2 align-items-center">
      <select name="class_id" class="form-select form-select-sm" style="width:160px" onchange="this.form.submit()">
...
<!-- Add period -->
<div class="sec-card mb-3">
  <div class="sec-card-header" data-bs-toggle="collapse" data-bs-target="#addPeriod" style="cursor:pointer">
    <i class="fas fa-plus me-2"></i>Add Period <i class="fas fa-chevron-down ms-auto"></i>
  </div>
...
<!-- Timetable -->
<div class="sec-card">
  <div class="sec-card-header"><i class="fas fa-table me-2"></i>Timetable</div>
