...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'change_password') {
    ...
    redirect('/portal/vp/profile.php');
}

pageHead('My Profile', 'vp_main');
$links = getVpLinks();
?>
<div class="portal-wrap">
<?php sidebar('vp_main', 'profile', $links, $user); ?>
<div class="main-area">
...
<div class="row g-3">
  <div class="col-md-4">
    <?php $returnUrl = '/portal/vp/profile.php'; include __DIR__ . '/../includes/photo-upload-widget.php'; ?>
    <div class="sec-card">
      ...
      <div style="padding:16px">
        <table class="table table-sm mb-0" style="font-size:.86rem">
          ...
          <tr><th style="color:#6b7280">Role</th><td>VP Main</td></tr>
        </table>
      </div>
    </div>
  </div>
