...
<div class="sec-card mb-4">
  ...
  <div>
    ...
    <?php $secData = $rfd[$sk] ?? []; ?>
    <div class="px-3 pt-2">
      <div style="font-size:.74rem;font-weight:700;color:#fff;background:<?= $sec['color'] ?>;
      ...
      <div class="table-responsive">
        <table class="table table-sm table-bordered mb-0" style="font-size:.8rem;border-top:none">
          <thead><tr style="background:<?= $sec['theadbg'] ?>">
          ...
          <tr style="background:<?= $sec['subbg'] ?>">
            <td colspan="3" class="fw-semibold" style="font-size:.76rem;color:<?= $sec['subtxt'] ?>;padding:3px 10px">
              <?= $subTitle ?>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="text-center"><?= prBadge($secData[$fk] ?? '') ?></td>
          </tr>
          <?php endforeach; ?>
          <?php endforeach; ?>
          </tbody>
