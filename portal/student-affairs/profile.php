...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'change_password') {
    ...
    redirect('/portal/student-affairs/profile.php');
}

pageHead('My Profile', 'student_affairs');
$links = getStudentAffairsLinks();
?>
<div class="portal-wrap">
<?php sidebar('student_affairs', 'profile', $links, $user); ?>
<div class="main-area">
...
<div class="row g-3">
  <div class="col-md-4">
    <?php $returnUrl = '/portal/student-affairs/profile.php'; include __DIR__ . '/../includes/photo-upload-widget.php'; ?>
    <div class="sec-card">
      ...
      <div style="padding:16px">
        <table class="table table-sm mb-0" style="font-size:.86rem">
          ...
          <tr><th style="color:#6b7280">Role</th><td>Student Affairs</td></tr>
        </table>
      </div>
    </div>
  </div>
