...
pageHead('My Profile', 'finance');
$links = getFinanceLinks();
?>
<div class="portal-wrap">
<?php sidebar('finance', 'profile', $links, $user); ?>
<div class="main-area">
...
<div class="row g-3">
  <div class="col-md-4">
    <?php $returnUrl = '/portal/finance/profile.php'; include __DIR__ . '/../includes/photo-upload-widget.php'; ?>
    <div class="sec-card">
